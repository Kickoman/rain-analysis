...
class Settings(BaseSettings):
    ...
    # (comma-separated, as documented in .env.example). Stored as a plain
    # string because pydantic-settings insists on JSON for list-typed
    # fields, which made the documented comma form fail at startup.
    cors_origins: str = "https://kickoman.github.io,http://localhost:3000"
