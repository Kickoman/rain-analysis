...
def test_api_keys_salt_rejects_old_default_value(monkeypatch):
    """Test that the old insecure default value is rejected."""
...
def test_api_keys_salt_rejects_new_placeholder_value(monkeypatch):
    """Test that the new placeholder value is rejected."""
    if 'app.config' in sys.modules:
        del sys.modules['app.config']
...
def test_env_example_contains_obvious_placeholder():
    """Test that .env.example contains an obvious placeholder that will be rejected."""
    ...
    # The .env.example should contain the new obvious placeholder
